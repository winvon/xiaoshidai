...
//            ['category_name', 'checkUnique'],
            ...
            [['icon', 'created_at', 'updated_at'], 'string', 'max' => 100],
        ];
    }
    ...
    public function scenarios()
    {
        return array_merge(parent::scenarios(), [
            'update' => ['category_name', 'icon', 'display_order', 'parent_id', 'is_show'],
            'delete' => ['is_delete'],
            'show' => ['is_show'],
